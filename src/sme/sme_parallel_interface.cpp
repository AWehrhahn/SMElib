...
{
  return _FreeState(clean_pointers, state);
}
...
extern "C" int SME_DLL Parallel_GetNLINES(int n, void *args[], GlobalState *state)
{
  return state->NLINES;
}

extern "C" short SME_DLL Parallel_GetNRHOX(int n, void *args[], GlobalState *state)
{
  return state->NRHOX;
}

extern "C" char *SME_DLL Parallel_GetSPNAME(int n, void *args[], GlobalState *state)
{
  return state->spname;
}

extern "C" char const *SME_DLL Parallel_SMELibraryVersion(int n, void *arg[], GlobalState *state) /* Return SME library version */
{
  return _SMELibraryVersion();
}

extern "C" char const *SME_DLL Parallel_GetDataFiles(int n, void *arg[], GlobalState *state) /* Return SME library version */
{
  return _GetDataFiles();
}

extern "C" char const *SME_DLL Parallel_GetLibraryPath(int n, void *arg[], GlobalState *state)
{
...
*/
extern "C" char const *SME_DLL Parallel_SetLibraryPath(int n, void *arg[], GlobalState *state)
{
  if (n != 1)
  {
...
extern "C" char const *SME_DLL Parallel_InputWaveRange(int n, void *arg[], GlobalState *state) /* Read in Wavelength range */
{
  if (n < 2)
  {
...
extern "C" char const *SME_DLL Parallel_SetVWscale(int n, void *arg[], GlobalState *state) /* Set van der Waals scaling factor */
{
  if (n < 1)
  {
...
extern "C" char const *SME_DLL Parallel_SetH2broad(int n, void *arg[], GlobalState *state) /* Set flag for H2 molecule */
{
  return _SetH2broad(1, state);
}

extern "C" char const *SME_DLL Parallel_ClearH2broad(int n, void *arg[], GlobalState *state) /* Clear flag for H2 molecule */
{
  return _SetH2broad(0, state);
}

extern "C" char const *SME_DLL Parallel_InputLineList(int n, void *arg[], GlobalState *state) /* Read in line list */
{
...
extern "C" char const *SME_DLL Parallel_OutputLineList(int n, void *arg[], GlobalState *state) /* Return line list */
{
  /*
...
extern "C" char const *SME_DLL Parallel_UpdateLineList(int n, void *arg[], GlobalState *state) /* Change line list parameters */
{
  /*
...
extern "C" char const *SME_DLL Parallel_InputModel(int n, void *arg[], GlobalState *state) /* Read in model atmosphere */
{
  if (n < 12)
  {
    return "Not enough arguments";
...
extern "C" char const *SME_DLL Parallel_InputDepartureCoefficients(int n, void *arg[], GlobalState *state)
{
...
extern "C" char const *SME_DLL Parallel_GetDepartureCoefficients(int n, void *arg[], GlobalState *state) /* Get NLTE b's for specific line */
{
...
extern "C" char const *SME_DLL Parallel_ResetDepartureCoefficients(int n, void *arg[], GlobalState *state) /* Reset LTE */
{
  return _ResetDepartureCoefficients(state);
}

extern "C" char const *SME_DLL Parallel_InputAbund(int n, void *arg[], GlobalState *state) /* Read in abundances */
{
  if (n < 1)
  {
    return "Not enough arguments";
...
extern "C" char const *SME_DLL Parallel_Opacity(int n, void *arg[], GlobalState *state) /* Calculate opacities */
{
  short i, nrhox;
  double *a1 = NULL;
  double *a2 = NULL;
...
extern "C" char const *SME_DLL Parallel_Ionization(int n, void *arg[], GlobalState *state)
{
...
extern "C" char const *SME_DLL Parallel_Transf(int n, void *arg[], GlobalState *state)
{
